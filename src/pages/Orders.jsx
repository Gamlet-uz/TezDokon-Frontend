...
export default function Orders({ store }) {
  ...
  // Sana va vaqtni chiroyli ko'rsatish funksiyasi
            ...
            <div key={order.id} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex flex-col">
              ...
              <div className="bg-gray-50 rounded-xl p-3 mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href={`tel:${order.customer?.phone}`} className="text-xs font-bold text-blue-600 hover:underline">
              ...
              {/* Boshqaruv tugmalari (Faqat Yangi buyurtmalar uchun) */}
              {order.status === 'new' && (
